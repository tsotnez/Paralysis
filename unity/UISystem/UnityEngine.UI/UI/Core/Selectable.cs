        ...
        ISelectHandler, IDeselectHandler
    {
        ...
        public bool              interactable
        {
            ...
            set
            {
                ...
                {
                    if (!m_Interactable && this.EventSystem != null && this.EventSystem.currentSelectedGameObject == gameObject)
        ...
        protected override void OnValidate()
        {
            ...
            {
                if (!interactable && this.EventSystem != null && this.EventSystem.currentSelectedGameObject == gameObject)
                    this.EventSystem.SetSelectedGameObject(null);
        ...
        public virtual void OnPointerDown(PointerEventData eventData)
        {
            ...
            // Selection tracking
            if (IsInteractable() && navigation.mode != Navigation.Mode.None && this.EventSystem != null)
                this.EventSystem.SetSelectedGameObject(gameObject, eventData);
        ...
        {
            if (this.EventSystem == null || this.EventSystem.alreadySelecting)
                return;
