    ...
    */
        ...
        ILayoutElement
    {
        ...
        private BaseInput input
        {
            get
            {
                if (this.EventSystem && this.EventSystem.currentInputModule)
                    return this.EventSystem.currentInputModule.input;
                return null;
            }
        }
        ...
        private void ActivateInputFieldInternal()
        {
            ...
            if (this.EventSystem.currentSelectedGameObject != gameObject)
